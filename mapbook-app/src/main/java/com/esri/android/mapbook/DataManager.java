...
public class DataManager {
  ...
  public void queryForFeatures(Geometry geometry, LayerList layers, Callbacks.FeatureCallback callback){
  ...
  private void processQueryForFeatures(final ListenableFuture<FeatureQueryResult> futureResult, final FeatureLayer featureLayer, final Callbacks.FeatureCallback callback ){
